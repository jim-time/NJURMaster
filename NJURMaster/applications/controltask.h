...
extern volatile float GMPitchOutput,GMYawOutput;
extern volatile float pitch_speed,yaw_speed;
...
extern uint32_t FireSpeed, CM4_Time;
extern float CM4_angle, last_CM4_angle;
#endif
